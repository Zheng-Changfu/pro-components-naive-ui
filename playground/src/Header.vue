...
const emit = defineEmits([
  ...
  'toggleTheme',
  'toggleAutosave',
  'toggleProComponentsVersion',
])

const { store } = props
const proComponentsVersion = getCurrentVersion('pro-components-naive-ui')
...
async function setProComponentsVersion(v: string) {
  proComponentsVersion.value = v
  emit('toggleProComponentsVersion', v)
}
...
<template>
  <nav>
    ...
    <div class="links">
      <VersionSelect
        :model-value="proComponentsVersion" pkg="pro-components-naive-ui"
        label="Pro-components-naive-ui Version" @update:model-value="setProComponentsVersion"
      />
