...
import { proDateYearRangeExtendSlotKeys } from './slots'
...
export default defineComponent({
  ...
  setup(props, { slots, expose }) {
    ...
    const { proDateYearRange } = useInjectGlobalConfigContext()
    const pickerSlots = useOmitSlots(slots, proDateYearRangeExtendSlotKeys)
    ...
    const valueFormat = computed(() => {
      ...
      return valueFormat ?? proDateYearRange.valueFormat
    })
