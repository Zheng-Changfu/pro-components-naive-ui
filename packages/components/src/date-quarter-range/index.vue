...
import { proDateQuarterRangeExtendSlotKeys } from './slots'
...
export default defineComponent({
  ...
  setup(props, { slots, expose }) {
    ...
    const { proDateQuarterRange } = useInjectGlobalConfigContext()
    const pickerSlots = useOmitSlots(slots, proDateQuarterRangeExtendSlotKeys)
    ...
    const valueFormat = computed(() => {
      ...
      return valueFormat ?? proDateQuarterRange.valueFormat
    })
