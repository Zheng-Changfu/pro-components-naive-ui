...
import { proDateWeekExtendSlotKeys } from './slots'
...
export default defineComponent({
  ...
  setup(props, { slots, expose }) {
    ...
    const { proDateWeek } = useInjectGlobalConfigContext()
    const pickerSlots = useOmitSlots(slots, proDateWeekExtendSlotKeys)
    ...
    const valueFormat = computed(() => {
      ...
      return valueFormat ?? proDateWeek.valueFormat
    })
